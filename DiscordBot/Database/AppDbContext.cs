...
public sealed class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    private void GuildAndIdBaseEntityConfiguration<T>(EntityTypeBuilder<T> entity, bool idAutoGenerated = true) where T : GuildAndIdBaseEntity
    {
        entity.HasKey(x => x.InternalId);
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EventEntity>(entity => { GuildAndIdBaseEntityConfiguration(entity); });

        modelBuilder.Entity<EventRepeatabilityEntity>(entity =>
        {
            GuildAndIdBaseEntityConfiguration(entity, false);
        ...
        modelBuilder.Entity<EventTemplateEntity>(entity => { GuildAndIdBaseEntityConfiguration(entity); });
